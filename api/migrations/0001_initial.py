    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria_equipo', models.IntegerField(blank=True, choices=[(1, 'Eléctrico'), (2, 'Hidráulico'), (4, 'Mecánico'), (8, 'General')], null=True)),
                ('prioridad', models.IntegerField(blank=True, choices=[(100, 'Alta'), (50, 'Media'), (10, 'Baja'), (999, 'Crítica')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.IntegerField(choices=[(1, 'Eléctrico'), (2, 'Hidráulico'), (4, 'Mecánico'), (8, 'General')], verbose_name='Categoría')),
                ...
                ('estado', models.CharField(default='operativo', max_length=20, verbose_name='Estado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(default='idle', max_length=20, verbose_name='Estado')),
                ...
                ('modelo_path', models.CharField(blank=True, max_length=500, verbose_name='Path del modelo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('tecnico', 'Técnico'), ('repuesto', 'Repuesto'), ('proveedor', 'Proveedor')], max_length=20, verbose_name='Tipo de recurso')),
                ('nombre', models.CharField(max_length=100, verbose_name='Nombre')),
                ('especialidad', models.CharField(blank=True, max_length=50, verbose_name='Especialidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('preventivo', 'Mantenimiento Preventivo'), ('correctivo', 'Mantenimiento Correctivo'), ('inspeccion', 'Inspección')], max_length=20, verbose_name='Tipo')),
                ('prioridad', models.IntegerField(choices=[(100, 'Alta'), (50, 'Media'), (10, 'Baja'), (999, 'Crítica')], verbose_name='Prioridad')),
                ('estado', models.IntegerField(choices=[(1, 'Pendiente'), (2, 'En Progreso'), (4, 'Completado'), (8, 'Cancelado')], default=1, verbose_name='Estado')),
                ('tecnico_asignado', models.CharField(blank=True, max_length=100, verbose_name='Técnico')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('incidente', 'Incidente'), ('telemetria', 'Telemetría IoT'), ('flujo', 'Flujo de Proceso')], max_length=20, verbose_name='Tipo de evento')),
                ...
                ('equipo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='eventos', to='api.equipo')),
            ],
            options={
                'verbose_name': 'Evento',
